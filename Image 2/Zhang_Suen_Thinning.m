function ZS_thin_img = Zhang_Suen_Thinning(img, Otsu_T)
%3.1. Convert the image to a binary image
[m, n] = size(img);
binary = double(img>Otsu_T); %Used the basic global thresholing method to simpify the margin determination
